...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="吴世佳"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="123434552"/>
		<input type="hidden" name="orderShipping.receiverState" value="重庆"/>
		...
		<input type="hidden" name="orderShipping.receiverAddress" value="崇文路 xxxxxxxxx"/>
</form>
